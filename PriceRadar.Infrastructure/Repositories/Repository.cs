...
namespace PriceRadar.Infrastructure.Repositories
{
    ...
    {
        protected readonly YourNewsDbContext _dbContext;
        private DbSet<T> _dbSet;

        public Repository(YourNewsDbContext dbContext)
        {
        ...
        public async Task<IReadOnlyList<T>> GetAsync(Expression<Func<T, bool>> predicate = null, bool disableTracking = true)
        {
